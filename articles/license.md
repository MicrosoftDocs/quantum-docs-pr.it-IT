...
description: Condizioni di licenza, dichiarazioni di non responsabilità e diritti utente per la Microsoft Quantum Development Kit.
...
**SE SI VIVE IN (O SI È UN'AZIENDA CON LA SEDE PRINCIPALE DI BUSINESS IN) DEGLI STATI UNITI, VEDERE LA SEZIONE "ARBITRAGGIO DI BINDING E DEROGA PER L'AZIONE DI CLASSE" RIPORTATA DI SEGUITO. INFLUISCONO SUL MODO IN CUI VENGONO RISOLTE LE CONTROVERSIE.**
...
1. **INSTALLAZIONE E DIRITTI SULL'UTILIZZO.**
     ...
     a. **Generale**. Il licenziatario potrà utilizzare solo il software Microsoft Quantum Development Kit (anteprima) per facilitare lo sviluppo e il test delle applicazioni.
...
**Nota: poiché questo software viene distribuito in Canada, alcune clausole del presente contratto vengono fornite di seguito in francese**.

**Remarque: Ce logiciel Etant distribué au Canada, certaines des clauses dans ce contrat sont fournies ci-dessous en Français**.

**exonération de garantie. Le logiciel visé par une License est offert «tel questo». Toute utilization de Ce logiciel est à votre seule ques et péril. Microsoft n'accorde aucune autre garantie expresse. Vous pouvez bénéficier de droits additionnels en vertu du droit local sur la Protection des consommateurs, que ce contrat ne peut modifier. La ou elles sont permises par le impostazioni locali, Les garanzie implicites de qualité marchande, d'adéquation à ONU usage particulier et d'absence de contrefaçon sont exclues**.

**limitazione des dommages-intérêts ed esclusioni de responsabilité pour les dommages. Vous pouvez obtenir de Microsoft et de ses fournisseurs une indemnisation en cas de dommages directs uniquement à alterigia de 5,00 $ US. Vous ne pouvez prétendre à aucune indemnisation pour les autres dommages, y include les dommages spéciaux, indirects ou Accessories et pertes de bénéfices**.

**Preoccupazione limitazione cette**:
- **tout ce qui est relié au logiciel, aux services ou au contenu (y compris le code) figurant sur des sites Internet tiers ou dans des programmes tiers; et**
- **les réclamations au titolo de violazioni de contrat ou de garantie, ou au titolo de responsabilité stricte, de négligence ou d'une autre faute dans la limite autorisée par la loi en vigueur**.

**Elle s'applique également, même si Microsoft connaissait ou devrait connaître l'éventualité d'io tel dommage. Si votre paga n'autorise pas exclusion ou la limitazione de responsabilité pour les dommages indirects, Accessories ou de quelque nature que ce soit, il se peut que la limitazione ou exclusion ci-dessus ne appliquera pas à votre égard**.

**juridique effet. Le présent contrat décrit determinati droits juridiques. Vous pourriez avoir d'autres droits prévus par les Lois de votre pays. Le présent contrat ne modifié pas les droits que vous confèrent les Lois de votre pays si cells-ci ne le permettent pas**.
