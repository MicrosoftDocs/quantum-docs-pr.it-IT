...
Viene ora passata la `qSharpData` che rappresenta l'Hamiltoniana alla funzione `TrotterStepOracle` nella [simulazione di Dynamics hamiltoniana](xref:microsoft.quantum.libraries.standard.algorithms). `TrotterStepOracle` restituisce un'operazione Quantum che approssimano l'evoluzione in tempo reale dell'hamiltoniana.
