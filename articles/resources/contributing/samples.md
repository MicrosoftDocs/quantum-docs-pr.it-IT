...
Esaminando i file che compongono ogni cartella, è consigliabile approfondire l' [`algorithms/chsh-game/`](https://github.com/microsoft/Quantum/tree/main/samples/algorithms/chsh-game) esempio.
