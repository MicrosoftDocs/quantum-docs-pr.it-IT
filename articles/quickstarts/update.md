...
## <a name="updating-no-locq-projects"></a>Aggiornamento dei progetti Q# 
...
1. Eseguire l'aggiornamento alla versione più recente di Visual Studio 2019. Per le istruzioni, vedere [qui](https://docs.microsoft.com/visualstudio/install/update-visual-studio).
...
### <a name="update-no-locq-projects-in-visual-studio-code"></a>Aggiornare i progetti Q# in Visual Studio Code
...
3. Determinare la versione corrente del QDK. Per trovarla, è possibile esaminare le [note sulla versione](https://docs.microsoft.com/quantum/relnotes/). La versione è indicata in un formato simile a `0.12.20072031`.
...
### <a name="update-the-ino-locq-jupyter-kernel"></a>Aggiornare li kernel IQ# per Jupyter
...
1. Aggiornare l'estensione VS Code per il calcolo quantistico
    ...
    - Riavviare VS Code
    - Passare alla scheda _ *Extensions**
