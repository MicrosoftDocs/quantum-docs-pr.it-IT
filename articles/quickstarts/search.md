...
1. Usare Quantum Development Kit per [creare un nuovo progetto Q# per l'applicazione da riga di comando](xref:microsoft.quantum.install.standalone). Assegnare al progetto il titolo `Grover`.
