...
Usare il metodo [simulate ()](https://docs.microsoft.com/python/qsharp-core/qsharp.loader.qsharpcallable) dalla Q# libreria Python con l'operazione importata Q# :
