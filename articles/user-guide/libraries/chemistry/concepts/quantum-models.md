...
Sebbene i meccanismi quantistici possano essere simulati in un computer Quantum discretizzazione questi Stati, la maggior parte del lavoro nel campo ha evitato questo approccio, perché richiede molti qubits per archiviare gli Stati ed è necessaria una procedura di preparazione dello stato complessa per preparare uno stato iniziale anti-simmetrico.
