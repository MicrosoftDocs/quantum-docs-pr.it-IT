...
title: Tipo definito dall'utente BigDiscreteDistribution
...
ms.locfileid: "96193200"
---
# <a name="bigdiscretedistribution-user-defined-type"></a>Tipo definito dall'utente BigDiscreteDistribution
...
Rappresenta una distribuzione di probabilità univariata su numeri interi di dimensioni arbitrarie.
...
### <a name="sample--unit--bigint"></a>Esempio: [unità](xref:microsoft.quantum.lang-ref.unit) => [bigint](xref:microsoft.quantum.lang-ref.bigint) 
