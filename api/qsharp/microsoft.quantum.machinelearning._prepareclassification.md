...
---
# <a name="_prepareclassification-operation"></a>Operazione _PrepareClassification
...
### <a name="encoder--littleendian--unit-adj--ctl"></a>codificatore: [LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian) => [unità](xref:microsoft.quantum.lang-ref.unit) ADJ + CTL
