...
---
# <a name="applybasischange-operation"></a>Operazione ApplyBasisChange
...
### <a name="ops--qubit--unit--is-adj--ctl"></a>Ops: [](xref:microsoft.quantum.lang-ref.qubit) => [unità](xref:microsoft.quantum.lang-ref.unit) qubit è ADJ + CTL []
