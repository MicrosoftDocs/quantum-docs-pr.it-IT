...
title: Operazione ApplyPhaseLEOperationOnLECA
...
ms.locfileid: "96190803"
---
# <a name="applyphaseleoperationonleca-operation"></a>Operazione ApplyPhaseLEOperationOnLECA
...
### <a name="op--phaselittleendian--unit--is-adj--ctl"></a>op: [PhaseLittleEndian](xref:Microsoft.Quantum.Arithmetic.PhaseLittleEndian) => [unità](xref:microsoft.quantum.lang-ref.unit) PhaseLittleEndian è ADJ + CTL
