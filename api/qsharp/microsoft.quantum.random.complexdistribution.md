...
title: Tipo definito dall'utente ComplexDistribution
...
ms.locfileid: "96193149"
---
# <a name="complexdistribution-user-defined-type"></a>Tipo definito dall'utente ComplexDistribution
...
Rappresenta una distribuzione di probabilità univariata su numeri complessi.
...
### <a name="sample--unit--complex"></a>Esempio: [unità](xref:microsoft.quantum.lang-ref.unit) => [complessa](xref:Microsoft.Quantum.Math.Complex) 
