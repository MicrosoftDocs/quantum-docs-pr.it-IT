...
---
# <a name="_applyjordanwignerzterm_-operation"></a>Operazione _ApplyJordanWignerZTerm_
...
Applica l'evoluzione del tempo in base a un termine Z descritto da un oggetto `GeneratorIndex` .
