...
title: _ToJordanWignerSelectInput_ (funzione)
...
ms.locfileid: "92714241"
---
# <a name="_tojordanwignerselectinput_-function"></a>_ToJordanWignerSelectInput_ (funzione)
...
## <a name="output--qubitqubitqubitlittleendianlittleendian--unit-adj--ctl"></a>Output: ([qubit](xref:microsoft.quantum.lang-ref.qubit),[qubit](xref:microsoft.quantum.lang-ref.qubit)[],[qubit](xref:microsoft.quantum.lang-ref.qubit)[],[LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian),[LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian)[]) => [unità](xref:microsoft.quantum.lang-ref.unit) ADJ + CTL
