...
---
# <a name="continuousdistribution-user-defined-type"></a>Tipo definito dall'utente ContinuousDistribution
...
Rappresenta una distribuzione di probabilità univariata su numeri reali.
...
### <a name="sample--unit--double"></a>Esempio: [unità](xref:microsoft.quantum.lang-ref.unit) => [doppia](xref:microsoft.quantum.lang-ref.double) 
