...
---
# <a name="headmeasurement-function"></a>HeadMeasurement (funzione)
...
## <a name="output--qubit--__invalidresult__"></a>Output: [qubit](xref:microsoft.quantum.lang-ref.qubit)[] => __non <Result> valido__ 
