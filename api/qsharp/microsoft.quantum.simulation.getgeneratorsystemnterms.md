...
title: GetGeneratorSystemNTerms (funzione)
...
ms.locfileid: "96225194"
---
# <a name="getgeneratorsystemnterms-function"></a>GetGeneratorSystemNTerms (funzione)
...
Recupera il numero di termini in un oggetto `GeneratorSystem` .
...
Numero di termini in un oggetto `GeneratorSystem` .
