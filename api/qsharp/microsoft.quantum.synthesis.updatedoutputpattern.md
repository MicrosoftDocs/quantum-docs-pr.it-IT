...
title: UpdatedOutputPattern (funzione)
...
ms.locfileid: "92724451"
---
# <a name="updatedoutputpattern-function"></a>UpdatedOutputPattern (funzione)
...
Aggiornare un modello di output in base a Gate mask.
...
### <a name="pattern--int"></a>Modello: [int](xref:microsoft.quantum.lang-ref.int)
