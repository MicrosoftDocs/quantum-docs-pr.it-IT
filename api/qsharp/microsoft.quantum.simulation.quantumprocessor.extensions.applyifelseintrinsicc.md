...
---
# <a name="applyifelseintrinsicc-operation"></a>Operazione ApplyIfElseIntrinsicC
...
### <a name="onresultzeroop--unit--unit--is-ctl"></a>onResultZeroOp: [unità unità](xref:microsoft.quantum.lang-ref.unit) => [](xref:microsoft.quantum.lang-ref.unit) è CTL




### <a name="onresultoneop--unit--unit--is-ctl"></a>onResultOneOp: [unità unità](xref:microsoft.quantum.lang-ref.unit) => [](xref:microsoft.quantum.lang-ref.unit) è CTL
