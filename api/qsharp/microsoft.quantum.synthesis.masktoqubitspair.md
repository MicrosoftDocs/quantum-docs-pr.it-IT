...
---
# <a name="masktoqubitspair-function"></a>MaskToQubitsPair (funzione)
...
Trasforma la maschera dei bit di controllo e di destinazione in una coppia di qubits di controllo e qubits di destinazione
...
### <a name="mask--mcmtmask"></a>maschera: [MCMTMask](xref:Microsoft.Quantum.Synthesis.MCMTMask)
