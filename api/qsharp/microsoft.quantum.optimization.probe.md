...
ms.locfileid: "92724986"
---
# <a name="probe-function"></a>Funzione Probe
...
Dato un intervallo, restituisce un intervallo di probe che contrae l'intervallo specificato in base a un fattore del rapporto dorato.
...
### <a name="right--double"></a>a destra: [Double](xref:microsoft.quantum.lang-ref.double)
