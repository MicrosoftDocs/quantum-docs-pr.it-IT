...
### <a name="onequalop--t--unit-ctl--adj"></a>onEqualOp:' t => [unità](xref:microsoft.quantum.lang-ref.unit) CTL + ADJ
...
### <a name="onnonequalop--u--unit-ctl--adj"></a>onNonEqualOp:' U => [unità](xref:microsoft.quantum.lang-ref.unit) CTL + ADJ
