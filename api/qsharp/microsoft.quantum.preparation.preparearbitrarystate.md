...
---
# <a name="preparearbitrarystate-operation"></a>Operazione PrepareArbitraryState
...
> [!WARNING]
> PrepareArbitraryState è stato deprecato. Usare invece <xref:Microsoft.Quantum.Preparation.PrepareArbitraryStateCP>.
