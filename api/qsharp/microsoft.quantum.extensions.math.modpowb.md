...
ms.locfileid: "98821606"
---
# <a name="modpowb-function"></a>ModPowB (funzione)
...
> [!WARNING]
> ModPowB è stato deprecato. Usare invece <xref:Microsoft.Quantum.Math.ModPowL>.
>
> Usare @"microsoft.quantum.math.modpowl".
...
### <a name="exponent--bigint"></a>esponente: [bigint](xref:microsoft.quantum.lang-ref.bigint)
