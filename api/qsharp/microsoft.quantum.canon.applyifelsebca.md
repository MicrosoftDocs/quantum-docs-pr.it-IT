...
### <a name="trueop--t--unit-adj--ctl"></a>trueOp:' t => [unità](xref:microsoft.quantum.lang-ref.unit) ADJ + CTL
...
### <a name="falseop--u--unit-adj--ctl"></a>falseOp:' U => [unità](xref:microsoft.quantum.lang-ref.unit) ADJ + CTL
