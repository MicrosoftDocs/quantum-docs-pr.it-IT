...
---
# <a name="quantumrombitstringwriterbyindex-function"></a>QuantumROMBitStringWriterByIndex (funzione)
...
## <a name="output--littleendianlittleendian--unit-adj--ctl"></a>Output: ([LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian),[LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian)) => [unità](xref:microsoft.quantum.lang-ref.unit) ADJ + CTL
