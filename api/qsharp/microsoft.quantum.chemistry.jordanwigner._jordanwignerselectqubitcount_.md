...
---
# <a name="_jordanwignerselectqubitcount_-function"></a>_JordanWignerSelectQubitCount_ (funzione)
...
## <a name="output--intintintintintint"></a>Output: ([int](xref:microsoft.quantum.lang-ref.int), ([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)[]))
