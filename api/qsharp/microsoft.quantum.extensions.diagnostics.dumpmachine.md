...
Spazio dei nomi: [Microsoft. Quantum. Extensions. Diagnostics](xref:Microsoft.Quantum.Extensions.Diagnostics)

Pacchetto: [Microsoft. Quantum. QSharp. Core](https://nuget.org/packages/Microsoft.Quantum.QSharp.Core)


> [!WARNING]
> DumpMachine è stato deprecato. Usare invece <xref:Microsoft.Quantum.Diagnostics.DumpMachine>.
>
> Usare @"microsoft.quantum.diagnostics.dumpmachine".
