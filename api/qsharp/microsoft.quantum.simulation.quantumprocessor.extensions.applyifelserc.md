...
### <a name="onresultzeroop--t--unit--is-ctl"></a>onResultZeroOp:' t => [unità](xref:microsoft.quantum.lang-ref.unit)  è CTL
...
### <a name="onresultoneop--u--unit--is-ctl"></a>onResultOneOp:' U => [unità](xref:microsoft.quantum.lang-ref.unit)  è CTL
