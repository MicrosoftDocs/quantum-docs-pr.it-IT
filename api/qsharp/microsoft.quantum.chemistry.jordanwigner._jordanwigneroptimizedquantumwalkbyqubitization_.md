...
title: _JordanWignerOptimizedQuantumWalkByQubitization_ (funzione)
...
ms.locfileid: "96215606"
---
# <a name="_jordanwigneroptimizedquantumwalkbyqubitization_-function"></a>_JordanWignerOptimizedQuantumWalkByQubitization_ (funzione)
...
## <a name="output--intintdoublequbitqubit--unit--is-adj--ctl"></a>Output: (([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)), ([Double](xref:microsoft.quantum.lang-ref.double), ([qubit](xref:microsoft.quantum.lang-ref.qubit)[],[qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [unità](xref:microsoft.quantum.lang-ref.unit)  è ADJ + CTL))
