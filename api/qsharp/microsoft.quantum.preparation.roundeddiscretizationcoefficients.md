...
ms.locfileid: "96193540"
---
# <a name="roundeddiscretizationcoefficients-function"></a>RoundedDiscretizationCoefficients (funzione)
...
### <a name="coefficient--double"></a>coefficiente: [Double](xref:microsoft.quantum.lang-ref.double)
