...
title: ComplexAsComplexPolar (funzione)
...
ms.locfileid: "98848856"
---
# <a name="complexascomplexpolar-function"></a>ComplexAsComplexPolar (funzione)
...
Converte un numero complesso di tipo `Complex` in un numero complesso di tipo `ComplexPolar` .
