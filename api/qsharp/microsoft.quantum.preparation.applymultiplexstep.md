...
---
# <a name="applymultiplexstep-operation"></a>Operazione ApplyMultiplexStep
...
### <a name="disentangling--double"></a>districare: [Double](xref:microsoft.quantum.lang-ref.double)[]
