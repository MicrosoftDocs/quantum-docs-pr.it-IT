...
---
# <a name="_continuedfractionconvergenti-function"></a>Funzione _ContinuedFractionConvergentI
...
Chiamata ricorsiva interna per calcolare MCD con un associato
...
## <a name="output--fraction"></a>Output: [frazione](xref:Microsoft.Quantum.Math.Fraction)
